...
INSERT INTO "Monitor" ("MonitorID","SystemType","Monitor","Name","SQL","Description","Decimals","Mapping","ChartType","delta","MonitorType","SystemAverage","Interval","Unit") VALUES (NULL,'galera','failed_writesets','Failed Writesets','WSREP_LOCAL_CERT_FAILURES','No. of writesets with failed certification','1','','LineChart','0','GLOBAL','0','30',NULL);
INSERT INTO "Monitor" ("MonitorID","SystemType","Monitor","Name","SQL","Description","Decimals","Mapping","ChartType","delta","MonitorType","SystemAverage","Interval","Unit") VALUES (NULL,'galera','aborted_transactions','Aborted Transactions','WSREP_LOCAL_BF_ABORTS','No. of aborted local transactons','1','','LineChart','0','GLOBAL','0','30',NULL);
