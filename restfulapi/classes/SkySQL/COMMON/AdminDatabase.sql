...
/*
Need to look here possible devision by 0  - MR
 INSERT INTO "Monitor" ("MonitorID","SystemType","Monitor","Name","SQL","Description","Decimals","Mapping","ChartType","delta","MonitorType","SystemAverage","Interval","Unit") VALUES (NULL,'galera','innodb_buffer_pool_hit_ratio','InnoDB Buffer Pool Hit Ratio','Number(globals.getStatus("INNODB_BUFFER_POOL_READ_REQUESTS")) / (Number(globals.getStatus("INNODB_BUFFER_POOL_READ_REQUESTS")) + Number(globals("INNODB_BUFFER_POOL_READS"))) * 100','Hit ratio for the InnoDB Buffer Pool','2','','LineChart','0','JS','0','30','%');
*/
