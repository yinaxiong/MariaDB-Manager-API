...
INSERT INTO "Monitor" ("MonitorID","SystemType","Monitor","Name","SQL","Description","Decimals","Mapping","ChartType","delta","MonitorType","SystemAverage","Interval","Unit") VALUES (NULL,'galera','clustersize','Cluster Size','WSREP_CLUSTER_SIZE','The numbr of nodes inthe cluster','0','','null','0','GLOBAL','1','30','null');
...
INSERT INTO "Monitor" ("MonitorID","SystemType","Monitor","Name","SQL","Description","Decimals","Mapping","ChartType","delta","MonitorType","SystemAverage","Interval","Unit") VALUES (NULL,'galera','sendqueue','Avg. Send Queue','WSREP_LOCAL_SEND_QUEUE_AVG','Average sen queue length','1','','LineChart','0','GLOBAL','1','30','null');
INSERT INTO "Monitor" ("MonitorID","SystemType","Monitor","Name","SQL","Description","Decimals","Mapping","ChartType","delta","MonitorType","SystemAverage","Interval","Unit") VALUES (NULL,'galera','capacity','Capacity','(Number(globals.getStatus("THREADS_CONNECTED")) * 100) / Number(globals.getVariable("MAX_CONNECTIONS"))','Percentage threads in use','0','','null','0','JS','1','30','null');
...
INSERT INTO "Monitor" ("MonitorID","SystemType","Monitor","Name","SQL","Description","Decimals","Mapping","ChartType","delta","MonitorType","SystemAverage","Interval","Unit") VALUES (NULL,'galera','com_stmt_send_long_data','Statement Send Long Data','COM_STMT_SEND_LONG_DATA','No. of statement send logn data comands','0','','null','1','GLOBAL','1','30','null');
...
INSERT INTO "Monitor" ("MonitorID","SystemType","Monitor","Name","SQL","Description","Decimals","Mapping","ChartType","delta","MonitorType","SystemAverage","Interval","Unit") VALUES (NULL,'galera','innodb_buffer_pool_hit_ratio','InnoDB Buffer Pool Hit Ratio','Number(globals.getStatus("INNODB_BUFFER_POOL_READ_REQUESTS")) / (Number(globals.getStatus("INNODB_BUFFER_POOL_READ_REQUESTS")) + Number(globals("INNODB_BUFFER_POOL_READS"))) * 100','Hit ratio fo rthe InnoDB Buffer Pool','2','','LineChart','0','JS','0','30','%');
...
INSERT INTO "Monitor" ("MonitorID","SystemType","Monitor","Name","SQL","Description","Decimals","Mapping","ChartType","delta","MonitorType","SystemAverage","Interval","Unit") VALUES (NULL,'galera','innodb_row_lock_time_avg','InnoDB Avg. Row Lock','INNODB_ROW_LOCK_TIME_AVG','Average time to acquire a row lock','0','','LineChart','0','GLOBAL','0','30','ms');
...
INSERT INTO "Monitor" ("MonitorID","SystemType","Monitor","Name","SQL","Description","Decimals","Mapping","ChartType","delta","MonitorType","SystemAverage","Interval","Unit") VALUES (NULL,'galera','key_blocks_unused','Key Blocks Unused','KEY_BLOCKS_UNUSED','No. of unsused block s in the key cache','0','','null','1','GLOBAL','1','30','null');
