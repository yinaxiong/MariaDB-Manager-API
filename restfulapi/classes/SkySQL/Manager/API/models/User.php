...
use SkySQL\Manager\API\managers\UserManager;
use SkySQL\Manager\API\managers\UserPropertyManager;

class User extends EntityModel {
	protected static $setkeyvalues = true;
	
	protected static $managerclass = 'SkySQL\\Manager\\API\\managers\\UserManager';
